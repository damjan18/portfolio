          ...
          >
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="group/tech flex items-center gap-3 px-3 py-2.5 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-emerald-500/50 hover:bg-emerald-500/5 transition-colors">
                  <TechIcon icon={siAws} />
